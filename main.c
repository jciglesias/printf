...
/*   Updated: 2020/02/16 23:34:26 by jiglesia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	printf("|%-015.14"T"| %%0-15.17\n", N);
	printf("|%015.7"T"| %%015.17\n", N);
	printf("|%-15.7"T"| %%-15.17\n", N);
	printf("|%15.7"T"| %%15.17\n", N);
	printf("|%-015"T"| %%0-15\n", N);
	printf("|%015"T"| %%015\n", N);
	...
	ft_printf("|%-015.14"T"| %%-015.17\n", N);
	ft_printf("|%015.7"T"| %%015.17\n", N);
	ft_printf("|%-15.7"T"| %%-15.17\n", N);
	ft_printf("|%15.7"T"| %%15.17\n", N);
	ft_printf("|%-015"T"| %%-015\n", N);
	ft_printf("|%015"T"| %%015\n", N);
	ft_printf("|%-15"T"| %%-15\n", N);
